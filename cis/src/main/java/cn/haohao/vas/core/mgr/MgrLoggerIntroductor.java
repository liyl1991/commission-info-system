...
/**
 * 记录Manager的日志信息，log：Debug
 * 
 * @author jevons.zheng
 * @since 2009-07-25
 * @version 1.0
 */
public class MgrLoggerIntroductor implements MethodBeforeAdvice, AfterReturningAdvice {
	...
	public void before(Method method, Object[] args, Object target) throws Throwable {
		if (logger.isDebugEnabled()) {
			...
			logInfo.append("Execute Mgr:'");
			logInfo.append(target.getClass().getName());
	...
	public void afterReturning(Object returnValue, Method method, Object[] args, Object target) throws Throwable {
		if (logger.isDebugEnabled()) {
			StringBuffer logInfo = new StringBuffer();
			logInfo.append("Success! Execute Mgr:'");
			logInfo.append(target.getClass().getName());
			logInfo.append("' Method:'");
			logInfo.append(method.getName());
