...
/**
 * 记录Mgmt的日志信息，log：Debug
 * 
 * @author jevons.zheng
 * @since 2009-07-25
 * @version 1.0
 */
public class MgmtLoggerIntroductor implements MethodBeforeAdvice, AfterReturningAdvice {
	...
	public void afterReturning(Object returnValue, Method method, Object[] args, Object target) throws Throwable {
		if (logger.isDebugEnabled()) {
			StringBuffer logInfo = new StringBuffer();
			logInfo.append("Success! Execute Mgmt:'");
			logInfo.append(target.getClass().getName());
			logInfo.append("' Method:'");
			logInfo.append(method.getName());
