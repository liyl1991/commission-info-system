 ...
 *	VO
 */
public class VauditInfoQueryObj extends VauditInfo implements IPageable{
	...
	public VauditInfoQueryObj next() {
		this.currentPage += 1;
		return this;
	}
	public VauditInfoQueryObj previousOrFirst() {
		if(currentPage != 1)
			this.currentPage -= 1;
		return this;
	}
	public VauditInfoQueryObj first() {
		this.currentPage = 1;
		return this;
	}
