 ...
 *	VO
 */
public class AuditInfoQueryObj extends AuditInfo implements IPageable{
	...
	public AuditInfoQueryObj next() {
		this.currentPage += 1;
		return this;
	}
	public AuditInfoQueryObj previousOrFirst() {
		if(currentPage != 1)
			this.currentPage -= 1;
		return this;
	}
	public AuditInfoQueryObj first() {
		this.currentPage = 1;
		return this;
	}
